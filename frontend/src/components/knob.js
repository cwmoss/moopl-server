...
let gfx = svg`<svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
width="36px" height="36px" viewBox="0 0 47 47" xml:space="preserve">
<g>
    <g>
    ...
    c-0.013,0-0.025,0-0.038,0c-0.025,0-0.037,0-0.062,0c-1.028,0-1.868,0.852-1.868,1.893C21.537,6.206,22.39,7.045,23.417,7.045z" />
        <path class="knopf" style="transform-box:fill-box;transform-origin:center;transform:rotate(-164deg)" d="M23.505,10.494c-9.159,0-16.61,7.451-16.61,16.61c0,9.158,7.451,16.61,16.61,16.61c9.159,0,16.61-7.452,16.61-16.61
...
export default class Knob extends LitElement {
  static properties = {
    _value: { type: Number },
  ...
  set value(v) {
    this._value = v;
    let knob = this.shadowRoot?.querySelector(".knopf");
    // [-164, -144, -124 .. -4, 16 36 56 76] 0 .. 240
    //    k.style.transform = 'rotate(-44deg)'
    if (knob) {
      let deg = (240 * this._value) / 100 - 164;
  ...
  change_value(e) {
    console.log(
      "$$ change vol",
      e.target.value,
      this.shadowRoot.querySelector(".knopf")
    );
...
window.customElements.define("mo-knob", Knob);
